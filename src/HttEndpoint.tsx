...
const ParamFields = ({parameters, handleChange}) => {
    const fieldList: React.ReactElement[] = [];
    ...
    return (fieldList.length > 0) && <FormGroup label="Params" fieldId="simple-form-note-01">
        {fieldList}
    </FormGroup>
}
        ...
        <FormGroup>
            <Grid>
                ...
                {methodsMap.get(currentMethod)?.description &&
                    <div><GridItem span={6}>Description</GridItem>
                        <GridItem span={6}>
